...
namespace Ormery.Html
{
    public class SafeHtmlBuilder: C::IContextualAutoescapingAccumulator<HtmlEscaperContext, IHtmlEscaper>
    {
        ...
        public C::AutoescState<HtmlEscaperContext> State
        {
            get
            {
        ...
        {
            return C::IContextualAutoescapingAccumulator<HtmlEscaperContext, IHtmlEscaper>.PrepareForAppendDefault(this);
        }
        public void AppendSafe(string known___5756)
        {
            C::IContextualAutoescapingAccumulator<HtmlEscaperContext, IHtmlEscaper>.AppendSafeDefault(this, known___5756);
        }
    }
}
