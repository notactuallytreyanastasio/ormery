import {
  type as type__76, listBuilderAdd as listBuilderAdd_4, listBuilderAddAll as listBuilderAddAll_8, listedGet as listedGet_71, listBuilderToList as listBuilderToList_74, float64ToString as float64ToString_108, stringBuilderAppendCodePoint as stringBuilderAppendCodePoint_128, stringForEach as stringForEach_129, panic as panic_171
...
export class SqlDate extends type__76(SqlPart) {
  ...
  formatTo(builder_100) {
    builder_100[0] += "'";
    let t_101 = this.#value_98.toISOString().split("T")[0];
    builder_100[0] += t_101;
    builder_100[0] += "'";
    return;
  }
  /** @param {globalThis.Date} value_102 */
  constructor(value_102) {
    super ();
    this.#value_98 = value_102;
    return;
  }
...
export class SqlFloat64 extends type__76(SqlPart) {
  /** @type {number} */
  #value_104;
  /** @param {globalThis.Array<string>} builder_106 */
  formatTo(builder_106) {
    let t_107 = float64ToString_108(this.#value_104);
    builder_106[0] += t_107;
    return;
  }
  /** @param {number} value_109 */
  constructor(value_109) {
    super ();
    this.#value_104 = value_109;
    return;
  }
  /** @returns {number} */
  get value() {
    return this.#value_104;
  }
};
export class SqlInt32 extends type__76(SqlPart) {
  /** @type {number} */
  #value_111;
  /** @param {globalThis.Array<string>} builder_113 */
  formatTo(builder_113) {
    let t_114 = this.#value_111.toString();
    builder_113[0] += t_114;
    return;
  }
  /** @param {number} value_115 */
  constructor(value_115) {
    super ();
    this.#value_111 = value_115;
    return;
  }
  /** @returns {number} */
  get value() {
    return this.#value_111;
  }
};
export class SqlInt64 extends type__76(SqlPart) {
  /** @type {bigint} */
  #value_117;
  /** @param {globalThis.Array<string>} builder_119 */
  formatTo(builder_119) {
    let t_120 = this.#value_117.toString();
    builder_119[0] += t_120;
    return;
  }
  /** @param {bigint} value_121 */
  constructor(value_121) {
    super ();
    this.#value_117 = value_121;
    return;
  }
  /** @returns {bigint} */
  get value() {
...
export class SqlString extends type__76(SqlPart) {
  /** @type {string} */
  #value_123;
  /** @param {globalThis.Array<string>} builder_125 */
  formatTo(builder_125) {
    builder_125[0] += "'";
    function fn_126(c_127) {
      if (c_127 === 39) {
        builder_125[0] += "''";
      } else {
        try {
          stringBuilderAppendCodePoint_128(builder_125, c_127);
        } catch {
          throw Error();
        }
      }
    ...
    stringForEach_129(this.#value_123, fn_126);
    builder_125[0] += "'";
    return;
  }
  /** @param {string} value_130 */
  constructor(value_130) {
    super ();
    this.#value_123 = value_130;
    return;
  }
  /** @returns {string} */
  get value() {
    return this.#value_123;
  }
};
